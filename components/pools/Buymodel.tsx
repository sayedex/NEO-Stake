        ...
        <div className=" bg-[#1a1c1f] rounded-lg px-4 pt-5 pb-4 overflow-hidden shadow-xl transform transition-all">
          ...
          <div className="  ">
            <button
              onClick={() => closeModal()}
              type="button"
              className="inline-flex justify-center w-[90%] rounded-lg border border-transparent shadow-sm px-4 py-2 bg-gradient-to-r from-purple-500 to-indigo-600 text-white hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500 text-xl"
            >
              Close
            </button>
          </div>
